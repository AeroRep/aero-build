...
iso_name="Aero Desktop"
iso_label="AERO_DESKTOP_EVT_$(date --date="@${SOURCE_DATE_EPOCH:-$(date +%s)}" +%y%m)"
iso_publisher="Aero Team"
iso_application="Aero Desktop Installation DVD"
